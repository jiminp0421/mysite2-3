					...
					<form action="/mysite2/user" method="get">
						...
						<div class="form-group">
							<label class="form-text" for="input-uid">아이디</label> <span
								class="text-large bold">${requestScope.vo.id }</span>
						</div>
						...
						<div class="form-group">
							<label class="form-text" for="input-pass">패스워드</label> <input
								...
								value="${requestScope.vo.password }" placeholder="비밀번호를 입력하세요">
						</div>
						...
						<div class="form-group">
							<label class="form-text" for="input-name">이름</label> <input
								...
								value="${requestScope.vo.name }" placeholder="이름을 입력하세요">
						</div>
						...
						<div class="form-group">
							...
							<c:if test="${requestScope.vo.gender eq 'male'}">
							...
							<c:if test="${requestScope.vo.gender eq 'female'}">
								<label for="rdo-male">남</label>
								<input type="radio" id="rdo-male" name="gender" value="male">
